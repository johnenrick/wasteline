                    ...
                    <div class="col-sm-12" style="background-color:#66cc66;padding:50px 80px">
                        <div class="well" style="padding:50px 40px">
                         <form class="form-horizontal">
                          <fieldset>
                                <div class="col-sm-6 wl-reg-form" style="padding:20px 40px">

                                            <legend style="color:#333">Register</legend>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="col-md-10">
                                                ...
                                                <span class="help-block">Please be specific as possible. (House No./Block No./Citio, etc.)</span>
                                              </div>
                                            </div>
                                </div>
                                ...
                                <div class="col-sm-6" style="background-color: white">
                                            ...
                                            <div class="form-group" style="margin-top: 30px;">
                                              <div class="col-md-offset-2 col-md-10">
                                                <div class="checkbox">
                                                  <label>
                                                    <input type="checkbox"> I accept the Terms of Service & Privacy Policy.
                                                  </label>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="alert alert-dismissible alert-success">
                                              <button type="button" class="close" data-dismiss="alert">×</button>
                                              <strong>Well done!</strong> You successfully registered to Wasteline.
                                              <a href="javascript:void(0)" class="alert-link">Sign in now</a>.
                                            </div>
